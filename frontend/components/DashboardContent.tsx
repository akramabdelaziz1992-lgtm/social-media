        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="flex flex-col gap-0.5">
              <h1 className="text-xl md:text-3xl font-bold text-white leading-tight">لوحة التحكم</h1>
              <div className="flex flex-col">
                <span className="text-base md:text-lg font-semibold text-white/95">المسار الساخن</span>
                <span className="text-xs md:text-sm text-white/70">للسفر والسياحة</span>
              </div>
            </div>
          </div>
