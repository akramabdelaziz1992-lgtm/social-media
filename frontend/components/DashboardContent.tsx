      ...
      <div className="relative bg-gradient-to-r from-teal-600/20 via-emerald-600/20 to-teal-600/20 backdrop-blur-sm p-4 md:p-6 border-b border-white/10 shadow-2xl">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-4xl font-bold text-white">لوحة التحكم</h1>
              <div className="mt-1">
                <p className="text-lg md:text-xl font-semibold text-white/95 leading-tight">المسار الساخن</p>
                <p className="text-sm md:text-base text-white/80">للسفر والسياحة</p>
              </div>
            </div>
          </div>
